...
class Snake:
    ...
    # this function adds the segment to the snake
    ...
    # this function extend the snake by one segment
    ...
    # functions to set the direction of the snake head
    def up(self):
        """Moves snake upwards."""
    ...
    def down(self):
        ...
        # checks if the snake head is not in upward  using the "heading()"
